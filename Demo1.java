...
public class Demo1 {
    ...
    public static String[] mobilePriceScraper (String name){
        ...
        if (status.compareToIgnoreCase("No Search Results - Try Again! :)") == 0){
            driver.quit();
            throw new WebDriverException("No Search Results - Try Again! :) \nNO DATA FOUND AGAINST ENTERED NAME");
    ...
    public static String[] mobilePriceScraper2 (String name) {
        ...
        try{
            ...
            driver.quit();
            throw new WebDriverException("WebElement searchBox not found");
        }
    ...
    public static String[] mobilePriceScraper3 (String name) {
        String price  , currentURL = "none" ;
        String[] returns = new String[2];
